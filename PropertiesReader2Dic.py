...
# This code reads values of a particular section of the properties file into a dictionary.
# Usage: PropFileReader function should be passed as an argumen, the property file and the section to be read from it.
